# Questions(solve using recursion)
1. Write a program to calculate nth fibonacci number using recursion.
2. Perform linear search in 1-d array using recursion.
3. write a program to check whether the given array is sorted or not by using recursion.
